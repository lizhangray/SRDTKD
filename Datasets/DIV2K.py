...
class div2k(data.Dataset):
    ...
    def _set_filesystem(self, dir_data):
        if self.ext == ".npy":
            ...
            # revise by wedream.
            # self.root = dir_data + '/DIV2K_datasets'
            self.dir_hr = os.path.join(self.root, 'DIV2K_train_HR')
            # revise by wedream.
            # self.dir_lr = os.path.join(self.root, 'DIV2K_train_LR')
            self.dir_lr = os.path.join(self.root, 'DIV2K_train_LR_bicubic_X4')
            self.ext = '.png'
    ...
    def _get_patch(self, img_in, img_tar):
        ...
        if self.train:
            ...
            img_in, img_tar = img_in.copy(), img_tar.copy()
            # wedream end
